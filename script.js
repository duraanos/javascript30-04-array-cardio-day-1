...
const bornIn1500s = inventors.filter(inventor => inventor.year >= 1500);

// Array.prototype.map()
// 2. Give us an array of the inventors first and last names
const inventor = inventors.map(inventor => `${inventor.first} ${inventor.last}`);

// Array.prototype.sort()
// 3. Sort the inventors by birthdate, oldest to youngest
const sortingBirthdate = inventors.sort((a, b) => -(a.year - b.year));

// Array.prototype.reduce()
// 4. How many years did all the inventors live all together?
const totalYears = inventors.reduce((cur, acc) => cur + (acc.passed - acc.year), 0);

// 5. Sort the inventors by years lived
const sortingLivedYears = inventors.sort((a, b) => {
...
const sortingAlphabetical = people.sort((lastOne, nextOne) => {
